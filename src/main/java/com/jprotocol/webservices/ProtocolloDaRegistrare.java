...
/**
 * <p>Java class for protocolloDaRegistrare complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolloDaRegistrare">
 *   &lt;complexContent>
 ...
 *         &lt;element name="listaCorrispondenti" type="{http://WebServices.jprotocol.com/}mittDest" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "protocolloDaRegistrare", propOrder = {
    "allegati",
    "catDoc",
    "codTit",
    "codUffMittInterno",
...
public class ProtocolloDaRegistrare {
    ...
    @XmlElement(nillable = true)
    protected List<MittDest> listaCorrispondenti;
     ...
     * 
     */
    public List<MittDest> getListaCorrispondenti() {
        if (listaCorrispondenti == null) {
            listaCorrispondenti = new ArrayList<MittDest>();
        }
