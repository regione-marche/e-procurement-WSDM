 ...
 * generated in the org.datacontract.schemas._2004._07.siav_common_baseclass package. 
...
public class ObjectFactory {
    ...
    private final static QName _BaseHistoryIdHistory_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "IdHistory");
    private final static QName _BaseHistoryDescription_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "Description");
    private final static QName _BaseHistoryIdRes_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "IdRes");
    private final static QName _BaseHistoryUserId_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "UserId");
    private final static QName _BaseNoteNota_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "Nota");
    private final static QName _BaseNoteId_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "Id");
    private final static QName _BaseVisibilityDescDescOffices_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "DescOffices");
    private final static QName _BaseVisibilityDescDescUsers_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "DescUsers");
    private final static QName _BaseVisibilityDescDescGroups_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "DescGroups");
    private final static QName _TypeIdentifierName_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "Name");
    private final static QName _BaseVisibilityVisOffices_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "VisOffices");
    private final static QName _BaseVisibilityVisUsers_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "VisUsers");
    private final static QName _BaseVisibilityVisGroups_QNAME = new QName("http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", "VisGroups");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.datacontract.schemas._2004._07.siav_common_baseclass
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "IdHistory", scope = BaseHistory.class)
    public JAXBElement<BaseIdentifier> createBaseHistoryIdHistory(BaseIdentifier value) {
        return new JAXBElement<BaseIdentifier>(_BaseHistoryIdHistory_QNAME, BaseIdentifier.class, BaseHistory.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "Description", scope = BaseHistory.class)
    public JAXBElement<String> createBaseHistoryDescription(String value) {
        return new JAXBElement<String>(_BaseHistoryDescription_QNAME, String.class, BaseHistory.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "IdRes", scope = BaseHistory.class)
    public JAXBElement<BaseIdentifier> createBaseHistoryIdRes(BaseIdentifier value) {
        return new JAXBElement<BaseIdentifier>(_BaseHistoryIdRes_QNAME, BaseIdentifier.class, BaseHistory.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "UserId", scope = BaseHistory.class)
    public JAXBElement<TypeIdentifierComplete> createBaseHistoryUserId(TypeIdentifierComplete value) {
        return new JAXBElement<TypeIdentifierComplete>(_BaseHistoryUserId_QNAME, TypeIdentifierComplete.class, BaseHistory.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "Nota", scope = BaseNote.class)
    public JAXBElement<String> createBaseNoteNota(String value) {
        return new JAXBElement<String>(_BaseNoteNota_QNAME, String.class, BaseNote.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "Id", scope = BaseNote.class)
    public JAXBElement<BaseIdentifier> createBaseNoteId(BaseIdentifier value) {
        return new JAXBElement<BaseIdentifier>(_BaseNoteId_QNAME, BaseIdentifier.class, BaseNote.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "UserId", scope = BaseNote.class)
    public JAXBElement<TypeIdentifierComplete> createBaseNoteUserId(TypeIdentifierComplete value) {
        return new JAXBElement<TypeIdentifierComplete>(_BaseHistoryUserId_QNAME, TypeIdentifierComplete.class, BaseNote.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "DescOffices", scope = BaseVisibilityDesc.class)
    public JAXBElement<ArrayOfTypeIdentifier> createBaseVisibilityDescDescOffices(ArrayOfTypeIdentifier value) {
        return new JAXBElement<ArrayOfTypeIdentifier>(_BaseVisibilityDescDescOffices_QNAME, ArrayOfTypeIdentifier.class, BaseVisibilityDesc.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "DescUsers", scope = BaseVisibilityDesc.class)
    public JAXBElement<ArrayOfTypeIdentifier> createBaseVisibilityDescDescUsers(ArrayOfTypeIdentifier value) {
        return new JAXBElement<ArrayOfTypeIdentifier>(_BaseVisibilityDescDescUsers_QNAME, ArrayOfTypeIdentifier.class, BaseVisibilityDesc.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "DescGroups", scope = BaseVisibilityDesc.class)
    public JAXBElement<ArrayOfTypeIdentifier> createBaseVisibilityDescDescGroups(ArrayOfTypeIdentifier value) {
        return new JAXBElement<ArrayOfTypeIdentifier>(_BaseVisibilityDescDescGroups_QNAME, ArrayOfTypeIdentifier.class, BaseVisibilityDesc.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "Name", scope = TypeIdentifier.class)
    public JAXBElement<String> createTypeIdentifierName(String value) {
        return new JAXBElement<String>(_TypeIdentifierName_QNAME, String.class, TypeIdentifier.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "VisOffices", scope = BaseVisibility.class)
    public JAXBElement<ArrayOfEntityAccess> createBaseVisibilityVisOffices(ArrayOfEntityAccess value) {
        return new JAXBElement<ArrayOfEntityAccess>(_BaseVisibilityVisOffices_QNAME, ArrayOfEntityAccess.class, BaseVisibility.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "VisUsers", scope = BaseVisibility.class)
    public JAXBElement<ArrayOfEntityAccess> createBaseVisibilityVisUsers(ArrayOfEntityAccess value) {
        return new JAXBElement<ArrayOfEntityAccess>(_BaseVisibilityVisUsers_QNAME, ArrayOfEntityAccess.class, BaseVisibility.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "VisGroups", scope = BaseVisibility.class)
    public JAXBElement<ArrayOfEntityAccess> createBaseVisibilityVisGroups(ArrayOfEntityAccess value) {
        return new JAXBElement<ArrayOfEntityAccess>(_BaseVisibilityVisGroups_QNAME, ArrayOfEntityAccess.class, BaseVisibility.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.ValueObject", name = "Description", scope = TypeIdentifierComplete.class)
    public JAXBElement<String> createTypeIdentifierCompleteDescription(String value) {
        return new JAXBElement<String>(_BaseHistoryDescription_QNAME, String.class, TypeIdentifierComplete.class, value);
    }
