 ...
 *         &lt;element name="bLogic" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DeleteFascicolo")
public class DeleteFascicolo {
    ...
    /**
     * Gets the value of the bLogic property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isBLogic() {
        return bLogic;
    }

    /**
     * Sets the value of the bLogic property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setBLogic(Boolean value) {
        this.bLogic = value;
    }
