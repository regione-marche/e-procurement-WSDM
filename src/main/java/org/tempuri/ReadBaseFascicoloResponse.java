 ...
 *       &lt;sequence>
 *         &lt;element name="ReadBaseFascicoloResult" type="{http://schemas.datacontract.org/2004/07/SIAV.Common.BaseClass.Types}ResultInfo" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    "readBaseFascicoloResult",
    "pBaseFascColl"
})
@XmlRootElement(name = "ReadBaseFascicoloResponse")
public class ReadBaseFascicoloResponse {

    @XmlElement(name = "ReadBaseFascicoloResult")
    protected ResultInfo readBaseFascicoloResult;
    ...
    /**
     * Gets the value of the readBaseFascicoloResult property.
     * 
     * @return
     *     possible object is
     *     {@link ResultInfo }
     *     
     */
    public ResultInfo getReadBaseFascicoloResult() {
        return readBaseFascicoloResult;
    }

    /**
     * Sets the value of the readBaseFascicoloResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link ResultInfo }
     *     
     */
    public void setReadBaseFascicoloResult(ResultInfo value) {
        this.readBaseFascicoloResult = value;
    }
