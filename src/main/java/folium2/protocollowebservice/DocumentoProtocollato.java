...
public class DocumentoProtocollato  implements java.io.Serializable {
    ...
    private folium2.protocollowebservice.MittenteDestinatario[] mittentiDestinatari;
    ...
    public DocumentoProtocollato(
           ...
           java.lang.Long id,
           boolean isContenuto,
           folium2.protocollowebservice.MittenteDestinatario[] mittentiDestinatari,
     ...
     */
    public folium2.protocollowebservice.MittenteDestinatario[] getMittentiDestinatari() {
        return mittentiDestinatari;
    }
     ...
     */
    public void setMittentiDestinatari(folium2.protocollowebservice.MittenteDestinatario[] mittentiDestinatari) {
        this.mittentiDestinatari = mittentiDestinatari;
    }
