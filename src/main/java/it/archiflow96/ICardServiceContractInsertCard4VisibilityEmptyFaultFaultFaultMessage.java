...
public class ICardServiceContractInsertCard4VisibilityEmptyFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCard4VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow96.VisibilityEmptyFault visibilityEmptyFault) {
        super(message);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }

    public ICardServiceContractInsertCard4VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow96.VisibilityEmptyFault visibilityEmptyFault, Throwable cause) {
        super(message, cause);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }
