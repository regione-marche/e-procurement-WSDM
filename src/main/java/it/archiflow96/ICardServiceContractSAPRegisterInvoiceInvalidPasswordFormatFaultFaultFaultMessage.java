...
public class ICardServiceContractSAPRegisterInvoiceInvalidPasswordFormatFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPRegisterInvoiceInvalidPasswordFormatFaultFaultFaultMessage(String message, it.archiflow96.InvalidPasswordFormatFault invalidPasswordFormatFault) {
        super(message);
        this.invalidPasswordFormatFault = invalidPasswordFormatFault;
    }

    public ICardServiceContractSAPRegisterInvoiceInvalidPasswordFormatFaultFaultFaultMessage(String message, it.archiflow96.InvalidPasswordFormatFault invalidPasswordFormatFault, Throwable cause) {
        super(message, cause);
        this.invalidPasswordFormatFault = invalidPasswordFormatFault;
    }
