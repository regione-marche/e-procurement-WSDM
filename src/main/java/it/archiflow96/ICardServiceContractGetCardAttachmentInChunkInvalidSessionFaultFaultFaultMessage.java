...
public class ICardServiceContractGetCardAttachmentInChunkInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardAttachmentInChunkInvalidSessionFaultFaultFaultMessage(String message, it.archiflow96.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public ICardServiceContractGetCardAttachmentInChunkInvalidSessionFaultFaultFaultMessage(String message, it.archiflow96.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
