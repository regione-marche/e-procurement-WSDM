...
public class ICardServiceContractCheckPrivacyVisibilityInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractCheckPrivacyVisibilityInvalidSessionFaultFaultFaultMessage(String message, it.archiflow96.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public ICardServiceContractCheckPrivacyVisibilityInvalidSessionFaultFaultFaultMessage(String message, it.archiflow96.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
