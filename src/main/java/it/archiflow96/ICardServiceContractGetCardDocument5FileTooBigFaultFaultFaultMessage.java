...
public class ICardServiceContractGetCardDocument5FileTooBigFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardDocument5FileTooBigFaultFaultFaultMessage(String message, it.archiflow96.FileTooBigFault fileTooBigFault) {
        super(message);
        this.fileTooBigFault = fileTooBigFault;
    }

    public ICardServiceContractGetCardDocument5FileTooBigFaultFaultFaultMessage(String message, it.archiflow96.FileTooBigFault fileTooBigFault, Throwable cause) {
        super(message, cause);
        this.fileTooBigFault = fileTooBigFault;
    }
