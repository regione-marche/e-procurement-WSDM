...
public class IEMailServiceContractGetIndexesToStoreEmailEmailFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractGetIndexesToStoreEmailEmailFaultFaultFaultMessage(String message, it.archiflow96.email.EmailFault emailFault) {
        super(message);
        this.emailFault = emailFault;
    }

    public IEMailServiceContractGetIndexesToStoreEmailEmailFaultFaultFaultMessage(String message, it.archiflow96.email.EmailFault emailFault, Throwable cause) {
        super(message, cause);
        this.emailFault = emailFault;
    }
