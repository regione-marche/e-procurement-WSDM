...
public class IEMailServiceContractDeleteProxyArchiflowServiceExceptionDetailFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractDeleteProxyArchiflowServiceExceptionDetailFaultFaultMessage(String message, it.archiflow96.email.ArchiflowServiceExceptionDetail archiflowServiceExceptionDetail) {
        super(message);
        this.archiflowServiceExceptionDetail = archiflowServiceExceptionDetail;
    }

    public IEMailServiceContractDeleteProxyArchiflowServiceExceptionDetailFaultFaultMessage(String message, it.archiflow96.email.ArchiflowServiceExceptionDetail archiflowServiceExceptionDetail, Throwable cause) {
        super(message, cause);
        this.archiflowServiceExceptionDetail = archiflowServiceExceptionDetail;
    }
