...
public class IEMailServiceContractSendFolderByExternalMailParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractSendFolderByExternalMailParamValidationFaultFaultFaultMessage(String message, it.archiflow96.email.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public IEMailServiceContractSendFolderByExternalMailParamValidationFaultFaultFaultMessage(String message, it.archiflow96.email.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
