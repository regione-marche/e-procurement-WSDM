 ...
 *         &lt;element name="enCardVisibility" type="{http://schemas.datacontract.org/2004/07/SIAV.Archiflow.Entities.Types}EMailVisibility" minOccurs="0"/>
...
@XmlRootElement(name = "SendEx2")
public class SendEx2 {

    @XmlElement(nillable = true)
    protected SessionInfo oSessInfo;
    protected EMailVisibility enCardVisibility;
    @XmlElement(nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link EMailVisibility }
     *     
     */
    public EMailVisibility getEnCardVisibility() {
     ...
     *     
     */
    public void setEnCardVisibility(EMailVisibility value) {
