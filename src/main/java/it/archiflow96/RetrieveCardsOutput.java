 ...
 *         &lt;element name="InvoicesTotalAmounts" type="{http://schemas.datacontract.org/2004/07/SIAV.Archiflow.Entities.Card.ValueObject}InvoicesTotalAmounts" minOccurs="0"/>
    ...
    extends BaseOutput
{
    ...
    @XmlElement(name = "InvoicesTotalAmounts", nillable = true)
    protected InvoicesTotalAmounts invoicesTotalAmounts;
    ...
    /**
     * Gets the value of the invoicesTotalAmounts property.
     * 
     * @return
     *     possible object is
     *     {@link InvoicesTotalAmounts }
     *     
     */
    public InvoicesTotalAmounts getInvoicesTotalAmounts() {
        return invoicesTotalAmounts;
    }

    /**
     * Sets the value of the invoicesTotalAmounts property.
     * 
     * @param value
     *     allowed object is
     *     {@link InvoicesTotalAmounts }
     *     
     */
    public void setInvoicesTotalAmounts(InvoicesTotalAmounts value) {
        this.invoicesTotalAmounts = value;
    }
