 ...
 *         &lt;element name="CreationDataFrom" type="{http://schemas.datacontract.org/2004/07/SIAV.Classification.Entities.Common.BaseClass}CustomDateTimeNullable" minOccurs="0"/>
 *         &lt;element name="CreationDataTo" type="{http://schemas.datacontract.org/2004/07/SIAV.Classification.Entities.Common.BaseClass}CustomDateTimeNullable" minOccurs="0"/>
...
public class FascicoloSearcher {
    ...
    @XmlElement(name = "CreationDataFrom", nillable = true)
    protected CustomDateTimeNullable creationDataFrom;
    @XmlElement(name = "CreationDataTo", nillable = true)
    protected CustomDateTimeNullable creationDataTo;
    ...
    /**
     * Gets the value of the creationDataFrom property.
     * 
     * @return
     *     possible object is
     *     {@link CustomDateTimeNullable }
     *     
     */
    public CustomDateTimeNullable getCreationDataFrom() {
        return creationDataFrom;
    }

    /**
     * Sets the value of the creationDataFrom property.
     * 
     * @param value
     *     allowed object is
     *     {@link CustomDateTimeNullable }
     *     
     */
    public void setCreationDataFrom(CustomDateTimeNullable value) {
        this.creationDataFrom = value;
    }

    /**
     * Gets the value of the creationDataTo property.
     * 
     * @return
     *     possible object is
     *     {@link CustomDateTimeNullable }
     *     
     */
    public CustomDateTimeNullable getCreationDataTo() {
        return creationDataTo;
    }

    /**
     * Sets the value of the creationDataTo property.
     * 
     * @param value
     *     allowed object is
     *     {@link CustomDateTimeNullable }
     *     
     */
    public void setCreationDataTo(CustomDateTimeNullable value) {
        this.creationDataTo = value;
    }
