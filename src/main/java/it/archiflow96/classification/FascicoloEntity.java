 ...
 *         &lt;element name="CreationData" type="{http://schemas.datacontract.org/2004/07/SIAV.Classification.Entities.Common.BaseClass}CustomDateTimeNullable" minOccurs="0"/>
    ...
    extends BaseFascicolo
{
    ...
    @XmlElement(name = "CreationData", nillable = true)
    protected CustomDateTimeNullable creationData;
     ...
     *     
     */
    public CustomDateTimeNullable getCreationData() {
        return creationData;
    }
     ...
     *     
     */
    public void setCreationData(CustomDateTimeNullable value) {
