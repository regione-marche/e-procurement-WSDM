...
public class ICardServiceContractSAPRegisterInvoiceChangePasswordFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPRegisterInvoiceChangePasswordFaultFaultFaultMessage(String message, it.archiflow96.ChangePasswordFault changePasswordFault) {
        super(message);
        this.changePasswordFault = changePasswordFault;
    }

    public ICardServiceContractSAPRegisterInvoiceChangePasswordFaultFaultFaultMessage(String message, it.archiflow96.ChangePasswordFault changePasswordFault, Throwable cause) {
        super(message, cause);
        this.changePasswordFault = changePasswordFault;
    }
