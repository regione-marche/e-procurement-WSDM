 ...
 * 
 */
public class FoliumUtilityControllo {
  ...
  // static private final String CTR_MESSAGE_CLASSIFICA =
  // "la classifica non rispetta il formato previsto (categoria.classe.sottoclasse.sotto-sottoclasse.fascicolo.titolare per esempio 41.1...1.1)";
  ...
  public static boolean ctrProtocolloInserisci(WSDMLoginAttr loginAttr, WSDMProtocolloDocumentoIn wsdmprotocolloDocumentoIn,
    ...
    // Controllo esecuzione "salva documento".
    // Su richiesta della Provincia di Alessandria bisogna inibire
    // le chiamate al servizio "salvaDocumento" per impedire l'inserimento
    // dei documenti nel documentale.
    // Di default si assume che l'inserimento dei documenti venga sempre
    // effettuato.
    // La nuova proprieta' non e' obbligatoria, se non presente si assume di
    // default "SI".
    // Se presente si legge il valore.
    // Vedi JIRA WSDM-42
