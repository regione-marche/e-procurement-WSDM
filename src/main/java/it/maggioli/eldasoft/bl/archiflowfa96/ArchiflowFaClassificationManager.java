...
import it.archiflow96.classification.ArrayOfFascicoloEntity;
import it.archiflow96.classification.BaseIdentifier;
import it.archiflow96.BaseInput;
import it.archiflow96.classification.ClassificationService;
import it.archiflow96.classification.FascicoloEntity;
import it.archiflow96.classification.FascicoloIdentifier;
import it.archiflow96.classification.FascicoloSearcher;
import it.archiflow96.classification.IClassificationService;
import it.archiflow96.classification.ReadFascicoloInput;
import it.archiflow96.classification.ReadFascicoloOutput;
...
public class ArchiflowFaClassificationManager {
  ...
  public FascicoloEntity getReadFascicolo(SessionInfo sessionInfoLogin, String codiceFascicolo) throws ArchiflowFaException {
    ...
    try {
      ...
      it.archiflow96.classification.SessionInfo sessionInfoClassification = new it.archiflow96.classification.SessionInfo();
