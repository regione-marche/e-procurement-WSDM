...
public class EngineeringDocManagerLegacy implements IWSDMManager {

  static Logger               logger                              = Logger.getLogger(EngineeringDocManagerLegacy.class);
  ...
  public WSDMProtocolloDocumentoRes _documentoInserisci(String username, String password, WSDMLoginAttr loginAttr,
    ...
    try {
      ...
      if (EngineeringDocUtilityControlloLegacy.ctrDocumentoInserisci(loginAttr, wsdmprotocolloDocumentoIn, messaggioCtr)) {
  ...
  public WSDMProtocolloDocumentoRes _documentoLeggi(String username, String password, WSDMLoginAttr loginAttr, String numeroDocumento) {
    ...
    try {
      ...
      StringBuffer messaggioCtr = new StringBuffer();
      if (EngineeringDocUtilityControlloLegacy.ctrDocumentoLeggi(loginAttr, numeroDocumento, messaggioCtr)) {
  ...
  public WSDMFascicoloRes _fascicoloInserisci(String username, String password, WSDMLoginAttr loginAttr, WSDMFascicoloIn wsdmfascicoloIn) {
    ...
    try {
      StringBuffer messaggioCtr = new StringBuffer();
      if (EngineeringDocUtilityControlloLegacy.ctrFascicoloInserisci(loginAttr, wsdmfascicoloIn, messaggioCtr)) {
  ...
  public WSDMFascicoloRes _fascicoloLeggi(String username, String password, WSDMLoginAttr loginAttr, String codiceFascicolo,
    ...
    try {
      StringBuffer messaggioCtr = new StringBuffer();
      if (EngineeringDocUtilityControlloLegacy.ctrFascicoloLeggi(loginAttr, codiceFascicolo, annoFascicolo, numeroFascicolo, messaggioCtr)) {
        ...
        WSGetMetadataFolderServiceLocator getMetadataFolderService = new WSGetMetadataFolderServiceLocator();
        ...
        headers.put("Authorization", "Bearer 1a079bea-6f37-321d-afb3-511be93d2bb9");
        ((Stub) getMetadataFolderPort)._setProperty(HTTPConstants.REQUEST_HEADERS, headers);
...
//        getMetadataFolderService.setEngineConfiguration(clientConfig);
//        getMetadataFolderService.setEngine(new AxisClient(clientConfig));
        ...
        if (WSRESULT_SUCCESS.equals(baseOutputMetadataFolder.getWSResult())) {
          ...
          if (attachmentMetadataFolder != null && attachmentMetadataFolder.length > 0) {
            ...
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            handler.writeTo(baos);
            String datiFolderXMLEscape = baos.toString();
