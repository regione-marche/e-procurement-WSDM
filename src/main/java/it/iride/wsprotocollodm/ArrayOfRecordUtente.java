 ...
 *       &lt;sequence>
 *         &lt;element name="Riga" type="{http://tempuri.org/}RecordUtente" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfRecordUtente {
    ...
    protected List<RecordUtente> riga;
     ...
     * 
     */
    public List<RecordUtente> getRiga() {
        if (riga == null) {
            riga = new ArrayList<RecordUtente>();
        }
        return this.riga;
    }
