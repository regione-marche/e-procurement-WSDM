...
public class DocumentoOut {
    ...
    @XmlElement(name = "MittenteInterno_Descrizione")
    ...
    @XmlElement(name = "InCaricoA_Descrizione")
    protected String inCaricoADescrizione;
    @XmlElement(name = "AnnoNumeroData")
    ...
    @XmlElement(name = "AnnoNumeroPratica")
    ...
    @XmlElement(name = "DataDiCarico", required = true)
    @XmlSchemaType(name = "dateTime")
    ...
    @XmlElement(name = "DataInizioPubblicazione", required = true)
    @XmlSchemaType(name = "dateTime")
