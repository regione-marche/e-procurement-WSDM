 ...
 *         &lt;element name="UriImportato" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
public class AllegatoOut {
    ...
    @XmlElement(name = "SottoEstensione")
    ...
    @XmlElement(name = "Pubblicato")
    protected String pubblicato;
    @XmlElement(name = "CommentoBilingue")
    protected String commentoBilingue;
    @XmlElement(name = "Uri")
    protected String uri;
    @XmlElement(name = "UriImportato")
    protected boolean uriImportato;
    ...
    /**
     * Gets the value of the uriImportato property.
     * 
     */
    public boolean isUriImportato() {
        return uriImportato;
    }

    /**
     * Sets the value of the uriImportato property.
     * 
     */
    public void setUriImportato(boolean value) {
        this.uriImportato = value;
    }
