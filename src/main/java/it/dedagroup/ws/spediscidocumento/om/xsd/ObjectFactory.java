...
package it.dedagroup.ws.spediscidocumento.om.xsd;
 ...
 * generated in the it.dedagroup.ws.spediscidocumento.om.xsd package. 
...
public class ObjectFactory {
    ...
    private final static QName _EsitoCodice_QNAME = new QName("http://om.protocollo.ws.dedagroup.it/xsd", "codice");
    private final static QName _EsitoDescrizione_QNAME = new QName("http://om.protocollo.ws.dedagroup.it/xsd", "descrizione");
    private final static QName _EsitoErrore_QNAME = new QName("http://om.protocollo.ws.dedagroup.it/xsd", "errore");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.dedagroup.ws.spediscidocumento.om.xsd
     * 
     */
    ...
    public JAXBElement<String> createEsitoDescrizione(String value) {
        return new JAXBElement<String>(_EsitoDescrizione_QNAME, String.class, Esito.class, value);
    }
    ...
    public JAXBElement<String> createErroreDescrizione(String value) {
        return new JAXBElement<String>(_EsitoDescrizione_QNAME, String.class, Errore.class, value);
    }
