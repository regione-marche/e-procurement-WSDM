...
public class ICardServiceContractSAPDeleteInvoiceByUserChangePasswordFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPDeleteInvoiceByUserChangePasswordFaultFaultFaultMessage(String message, it.archiflow93.ChangePasswordFault changePasswordFault) {
        super(message);
        this.changePasswordFault = changePasswordFault;
    }

    public ICardServiceContractSAPDeleteInvoiceByUserChangePasswordFaultFaultFaultMessage(String message, it.archiflow93.ChangePasswordFault changePasswordFault, Throwable cause) {
        super(message, cause);
        this.changePasswordFault = changePasswordFault;
    }
