...
public class ICardServiceContractGetCardDocumentFileTooBigFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardDocumentFileTooBigFaultFaultFaultMessage(String message, it.archiflow93.FileTooBigFault fileTooBigFault) {
        super(message);
        this.fileTooBigFault = fileTooBigFault;
    }

    public ICardServiceContractGetCardDocumentFileTooBigFaultFaultFaultMessage(String message, it.archiflow93.FileTooBigFault fileTooBigFault, Throwable cause) {
        super(message, cause);
        this.fileTooBigFault = fileTooBigFault;
    }
