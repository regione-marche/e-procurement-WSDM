...
public class ILoginServiceContractLoginLoginFaultFaultFaultMessage extends Exception {
    ...
    public ILoginServiceContractLoginLoginFaultFaultFaultMessage(String message, it.archiflow93.LoginFault loginFault) {
        super(message);
        this.loginFault = loginFault;
    }

    public ILoginServiceContractLoginLoginFaultFaultFaultMessage(String message, it.archiflow93.LoginFault loginFault, Throwable cause) {
        super(message, cause);
        this.loginFault = loginFault;
    }
