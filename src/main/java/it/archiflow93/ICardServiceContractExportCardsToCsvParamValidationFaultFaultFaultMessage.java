...
public class ICardServiceContractExportCardsToCsvParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractExportCardsToCsvParamValidationFaultFaultFaultMessage(String message, it.archiflow93.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public ICardServiceContractExportCardsToCsvParamValidationFaultFaultFaultMessage(String message, it.archiflow93.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
