...
public class ICardServiceContractGetCardAdditivesVisibilityFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardAdditivesVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault) {
        super(message);
        this.visibilityFault = visibilityFault;
    }

    public ICardServiceContractGetCardAdditivesVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault, Throwable cause) {
        super(message, cause);
        this.visibilityFault = visibilityFault;
    }
