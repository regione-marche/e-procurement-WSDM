...
public class ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage(String message, it.archiflow93.PhaseStatusNotFoundFault phaseStatusNotFoundFault) {
        super(message);
        this.phaseStatusNotFoundFault = phaseStatusNotFoundFault;
    }

    public ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage(String message, it.archiflow93.PhaseStatusNotFoundFault phaseStatusNotFoundFault, Throwable cause) {
        super(message, cause);
        this.phaseStatusNotFoundFault = phaseStatusNotFoundFault;
    }
