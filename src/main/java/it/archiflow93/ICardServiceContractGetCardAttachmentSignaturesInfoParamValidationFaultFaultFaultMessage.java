...
public class ICardServiceContractGetCardAttachmentSignaturesInfoParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardAttachmentSignaturesInfoParamValidationFaultFaultFaultMessage(String message, it.archiflow93.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public ICardServiceContractGetCardAttachmentSignaturesInfoParamValidationFaultFaultFaultMessage(String message, it.archiflow93.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
