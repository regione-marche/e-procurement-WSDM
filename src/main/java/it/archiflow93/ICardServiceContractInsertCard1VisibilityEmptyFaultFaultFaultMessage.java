...
public class ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow93.VisibilityEmptyFault visibilityEmptyFault) {
        super(message);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }

    public ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow93.VisibilityEmptyFault visibilityEmptyFault, Throwable cause) {
        super(message, cause);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }
