...
public class ICardServiceContractGetCardDocumentInfoByParamVisibilityFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardDocumentInfoByParamVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault) {
        super(message);
        this.visibilityFault = visibilityFault;
    }

    public ICardServiceContractGetCardDocumentInfoByParamVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault, Throwable cause) {
        super(message, cause);
        this.visibilityFault = visibilityFault;
    }
