...
public class ICardServiceContractInsertCard3VisibilityEmptyFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCard3VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow93.VisibilityEmptyFault visibilityEmptyFault) {
        super(message);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }

    public ICardServiceContractInsertCard3VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow93.VisibilityEmptyFault visibilityEmptyFault, Throwable cause) {
        super(message, cause);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }
