...
public class ICardServiceContractLoadAutoCollationTemplatesInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractLoadAutoCollationTemplatesInvalidSessionFaultFaultFaultMessage(String message, it.archiflow93.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public ICardServiceContractLoadAutoCollationTemplatesInvalidSessionFaultFaultFaultMessage(String message, it.archiflow93.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
