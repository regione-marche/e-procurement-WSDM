...
public class ICardServiceContractSAPDeleteInvoiceByUserLoginFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPDeleteInvoiceByUserLoginFaultFaultFaultMessage(String message, it.archiflow93.LoginFault loginFault) {
        super(message);
        this.loginFault = loginFault;
    }

    public ICardServiceContractSAPDeleteInvoiceByUserLoginFaultFaultFaultMessage(String message, it.archiflow93.LoginFault loginFault, Throwable cause) {
        super(message, cause);
        this.loginFault = loginFault;
    }
