...
public class IEMailServiceContractTestMailboxConnectionParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractTestMailboxConnectionParamValidationFaultFaultFaultMessage(String message, it.archiflow93.email.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public IEMailServiceContractTestMailboxConnectionParamValidationFaultFaultFaultMessage(String message, it.archiflow93.email.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
