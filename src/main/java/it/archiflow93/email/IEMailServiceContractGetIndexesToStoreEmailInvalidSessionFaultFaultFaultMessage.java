...
public class IEMailServiceContractGetIndexesToStoreEmailInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractGetIndexesToStoreEmailInvalidSessionFaultFaultFaultMessage(String message, it.archiflow93.email.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public IEMailServiceContractGetIndexesToStoreEmailInvalidSessionFaultFaultFaultMessage(String message, it.archiflow93.email.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
