...
public class IEMailServiceContractGetCustomMailFieldsXmlSchemaValidationFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractGetCustomMailFieldsXmlSchemaValidationFaultFaultFaultMessage(String message, it.archiflow93.email.XmlSchemaValidationFault xmlSchemaValidationFault) {
        super(message);
        this.xmlSchemaValidationFault = xmlSchemaValidationFault;
    }

    public IEMailServiceContractGetCustomMailFieldsXmlSchemaValidationFaultFaultFaultMessage(String message, it.archiflow93.email.XmlSchemaValidationFault xmlSchemaValidationFault, Throwable cause) {
        super(message, cause);
        this.xmlSchemaValidationFault = xmlSchemaValidationFault;
    }
