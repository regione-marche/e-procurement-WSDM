...
public class IEMailServiceContractGetCustomMailFieldsNoModelFoundFaultFaultFaultMessage extends Exception {
    ...
    private it.archiflow93.email.NoModelFoundFault noModelFoundFault;
    ...
    public IEMailServiceContractGetCustomMailFieldsNoModelFoundFaultFaultFaultMessage(String message, it.archiflow93.email.NoModelFoundFault noModelFoundFault) {
        super(message);
        this.noModelFoundFault = noModelFoundFault;
    }

    public IEMailServiceContractGetCustomMailFieldsNoModelFoundFaultFaultFaultMessage(String message, it.archiflow93.email.NoModelFoundFault noModelFoundFault, Throwable cause) {
        super(message, cause);
        this.noModelFoundFault = noModelFoundFault;
    }

    public it.archiflow93.email.NoModelFoundFault getFaultInfo() {
