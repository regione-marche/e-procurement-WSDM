...
public class IEMailServiceContractInsModMailServerParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractInsModMailServerParamValidationFaultFaultFaultMessage(String message, it.archiflow93.email.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public IEMailServiceContractInsModMailServerParamValidationFaultFaultFaultMessage(String message, it.archiflow93.email.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
