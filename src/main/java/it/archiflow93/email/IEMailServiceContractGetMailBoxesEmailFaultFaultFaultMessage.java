...
public class IEMailServiceContractGetMailBoxesEmailFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractGetMailBoxesEmailFaultFaultFaultMessage(String message, it.archiflow93.email.EmailFault emailFault) {
        super(message);
        this.emailFault = emailFault;
    }

    public IEMailServiceContractGetMailBoxesEmailFaultFaultFaultMessage(String message, it.archiflow93.email.EmailFault emailFault, Throwable cause) {
        super(message, cause);
        this.emailFault = emailFault;
    }
