...
public class IEMailServiceContractStoreEmailXmlSchemaValidationFaultFaultFaultMessage extends Exception {
    ...
    public IEMailServiceContractStoreEmailXmlSchemaValidationFaultFaultFaultMessage(String message, it.archiflow93.email.XmlSchemaValidationFault xmlSchemaValidationFault) {
        super(message);
        this.xmlSchemaValidationFault = xmlSchemaValidationFault;
    }

    public IEMailServiceContractStoreEmailXmlSchemaValidationFaultFaultFaultMessage(String message, it.archiflow93.email.XmlSchemaValidationFault xmlSchemaValidationFault, Throwable cause) {
        super(message, cause);
        this.xmlSchemaValidationFault = xmlSchemaValidationFault;
    }
