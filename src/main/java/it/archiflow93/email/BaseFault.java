...
@XmlSeeAlso({
    MailFault.class,
    NoModelFoundFault.class,
    XmlSelectNodeFault.class,
    VisibilityFault.class,
    PostingFault.class,
    NoRightsFault.class,
    NoDataFoundFault.class,
    CardNotFoundFault.class,
    EmailFault.class,
    InvalidSessionFault.class,
    MaxLimitFault.class,
    ValidLogCreatedFault.class,
    OperationFailedFault.class,
    XmlSchemaValidationFault.class,
