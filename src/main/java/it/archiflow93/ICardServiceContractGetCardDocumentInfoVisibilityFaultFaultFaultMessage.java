...
public class ICardServiceContractGetCardDocumentInfoVisibilityFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardDocumentInfoVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault) {
        super(message);
        this.visibilityFault = visibilityFault;
    }

    public ICardServiceContractGetCardDocumentInfoVisibilityFaultFaultFaultMessage(String message, it.archiflow93.VisibilityFault visibilityFault, Throwable cause) {
        super(message, cause);
        this.visibilityFault = visibilityFault;
    }
