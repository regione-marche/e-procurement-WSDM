...
@XmlSeeAlso({
    GetUsersCompanyResponseType.class,
    GetCompaniesResponseType.class,
    GetAoosResponseType.class,
    GetChannelsResponseType.class,
    GetDomainsResponseType.class,
    GetUsersDomainResponseType.class,
    GetFoldersResponseType.class,
    GetClassificationsResponseType.class,
    GetMetadatasResponseType.class
})
