 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://tempuri.org/}CopiaCreata" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfCopiaCreata {
    ...
    protected List<CopiaCreata> item;
     ...
     * 
     */
    public List<CopiaCreata> getItem() {
        if (item == null) {
            item = new ArrayList<CopiaCreata>();
        }
        return this.item;
    }
