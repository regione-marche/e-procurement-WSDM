 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://tempuri.org/}RecapitoIn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfRecapitoIn {
    ...
    protected List<RecapitoIn> item;
     ...
     * 
     */
    public List<RecapitoIn> getItem() {
        if (item == null) {
            item = new ArrayList<RecapitoIn>();
        }
        return this.item;
    }
