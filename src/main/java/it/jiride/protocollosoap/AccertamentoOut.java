...
public class AccertamentoOut {
    ...
    @XmlElement(name = "NumeroAccertamento", nillable = true)
    protected String numeroAccertamento;
    @XmlElement(name = "CapitoloAccertamento", nillable = true)
    protected String capitoloAccertamento;
    @XmlElement(name = "ArticoloAccertamento", nillable = true)
    protected String articoloAccertamento;
    @XmlElement(name = "CodSiopeAccertamento", nillable = true)
