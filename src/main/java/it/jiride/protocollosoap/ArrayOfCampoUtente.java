 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://tempuri.org/}CampoUtente" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfCampoUtente {
    ...
    protected List<CampoUtente> item;
     ...
     * 
     */
    public List<CampoUtente> getItem() {
        if (item == null) {
            item = new ArrayList<CampoUtente>();
        }
        return this.item;
    }
