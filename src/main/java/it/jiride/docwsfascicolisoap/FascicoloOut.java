 ...
 *         &lt;element name="PraticaRiservata" type="{http://www.w3.org/2001/XMLSchema}short"/>
 ...
 *         &lt;element name="Eterogeneo" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FascicoloOut {
    ...
    @XmlElement(name = "NumeroSenzaClassifica", nillable = true)
    ...
    @XmlElement(name = "Archiviata", nillable = true)
    ...
    @XmlElement(name = "RuoloDiInserimento", nillable = true)
    protected String ruoloDiInserimento;
    @XmlElement(name = "DataDiInserimento", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataDiInserimento;
    @XmlElement(name = "DataDiChiusura", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataDiChiusura;
    @XmlElement(name = "PraticaChiusa")
    protected boolean praticaChiusa;
    @XmlElement(name = "DataDiScarto", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataDiScarto;
    @XmlElement(name = "PraticaRiservata")
    protected short praticaRiservata;
    @XmlElement(name = "DocumentiFascicolo", nillable = true)
    protected ArrayOfDocumentoFascicoloOut documentiFascicolo;
    @XmlElement(name = "FormatoData", nillable = true)
    ...
    @XmlElement(name = "ACL", nillable = true)
    protected String acl;
    @XmlElement(name = "ErrDescription", nillable = true)
    protected String errDescription;
    @XmlElement(name = "DataDiAnnullo", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataDiAnnullo;
    @XmlElement(name = "PraticaAnnullata")
    protected boolean praticaAnnullata;
    @XmlElement(name = "AnnullamentoNote", nillable = true)
    protected String annullamentoNote;
    @XmlElement(name = "AnnullamentoUtente", nillable = true)
    ...
    @XmlElement(name = "SottoFascicolo", nillable = true)
    ...
    @XmlElement(name = "Eterogeneo")
    protected boolean eterogeneo;
     ...
     * 
     */
    public short getPraticaRiservata() {
     ...
     * 
     */
    public void setPraticaRiservata(short value) {
     ...
     * 
     */
    public void setEterogeneo(boolean value) {
