 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://tempuri.org/}DocumentoFascicoloOut" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfDocumentoFascicoloOut {
    ...
    protected List<DocumentoFascicoloOut> item;
     ...
     * 
     */
    public List<DocumentoFascicoloOut> getItem() {
        if (item == null) {
            item = new ArrayList<DocumentoFascicoloOut>();
        }
        return this.item;
    }
