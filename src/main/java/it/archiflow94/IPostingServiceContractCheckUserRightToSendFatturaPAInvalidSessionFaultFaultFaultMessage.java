...
public class IPostingServiceContractCheckUserRightToSendFatturaPAInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public IPostingServiceContractCheckUserRightToSendFatturaPAInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public IPostingServiceContractCheckUserRightToSendFatturaPAInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
