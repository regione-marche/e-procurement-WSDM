...
public class ICardServiceContractSAPDeleteInvoiceByUserParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPDeleteInvoiceByUserParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public ICardServiceContractSAPDeleteInvoiceByUserParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
