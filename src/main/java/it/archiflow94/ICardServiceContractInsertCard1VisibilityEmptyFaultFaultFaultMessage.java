...
public class ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow94.VisibilityEmptyFault visibilityEmptyFault) {
        super(message);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }

    public ICardServiceContractInsertCard1VisibilityEmptyFaultFaultFaultMessage(String message, it.archiflow94.VisibilityEmptyFault visibilityEmptyFault, Throwable cause) {
        super(message, cause);
        this.visibilityEmptyFault = visibilityEmptyFault;
    }
