...
public class ICardServiceContractSAPRegisterInvoiceErrorParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPRegisterInvoiceErrorParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public ICardServiceContractSAPRegisterInvoiceErrorParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
