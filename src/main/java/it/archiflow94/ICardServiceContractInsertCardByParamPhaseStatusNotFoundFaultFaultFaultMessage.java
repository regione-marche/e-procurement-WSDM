...
public class ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage(String message, it.archiflow94.PhaseStatusNotFoundFault phaseStatusNotFoundFault) {
        super(message);
        this.phaseStatusNotFoundFault = phaseStatusNotFoundFault;
    }

    public ICardServiceContractInsertCardByParamPhaseStatusNotFoundFaultFaultFaultMessage(String message, it.archiflow94.PhaseStatusNotFoundFault phaseStatusNotFoundFault, Throwable cause) {
        super(message, cause);
        this.phaseStatusNotFoundFault = phaseStatusNotFoundFault;
    }
