...
public class ICardServiceContractInsertCard4ValidLogCreatedFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractInsertCard4ValidLogCreatedFaultFaultFaultMessage(String message, it.archiflow94.ValidLogCreatedFault validLogCreatedFault) {
        super(message);
        this.validLogCreatedFault = validLogCreatedFault;
    }

    public ICardServiceContractInsertCard4ValidLogCreatedFaultFaultFaultMessage(String message, it.archiflow94.ValidLogCreatedFault validLogCreatedFault, Throwable cause) {
        super(message, cause);
        this.validLogCreatedFault = validLogCreatedFault;
    }
