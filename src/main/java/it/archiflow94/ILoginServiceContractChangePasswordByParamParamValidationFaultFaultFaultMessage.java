...
public class ILoginServiceContractChangePasswordByParamParamValidationFaultFaultFaultMessage extends Exception {
    ...
    public ILoginServiceContractChangePasswordByParamParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault) {
        super(message);
        this.paramValidationFault = paramValidationFault;
    }

    public ILoginServiceContractChangePasswordByParamParamValidationFaultFaultFaultMessage(String message, it.archiflow94.ParamValidationFault paramValidationFault, Throwable cause) {
        super(message, cause);
        this.paramValidationFault = paramValidationFault;
    }
