...
public class ICardServiceContractSAPDeleteInvoiceByUserUserAccountDisabledFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPDeleteInvoiceByUserUserAccountDisabledFaultFaultFaultMessage(String message, it.archiflow94.UserAccountDisabledFault userAccountDisabledFault) {
        super(message);
        this.userAccountDisabledFault = userAccountDisabledFault;
    }

    public ICardServiceContractSAPDeleteInvoiceByUserUserAccountDisabledFaultFaultFaultMessage(String message, it.archiflow94.UserAccountDisabledFault userAccountDisabledFault, Throwable cause) {
        super(message, cause);
        this.userAccountDisabledFault = userAccountDisabledFault;
    }
