...
public class ILoginServiceContractLoginInvalidPasswordLengthFaultFaultFaultMessage extends Exception {
    ...
    public ILoginServiceContractLoginInvalidPasswordLengthFaultFaultFaultMessage(String message, it.archiflow94.InvalidPasswordLengthFault invalidPasswordLengthFault) {
        super(message);
        this.invalidPasswordLengthFault = invalidPasswordLengthFault;
    }

    public ILoginServiceContractLoginInvalidPasswordLengthFaultFaultFaultMessage(String message, it.archiflow94.InvalidPasswordLengthFault invalidPasswordLengthFault, Throwable cause) {
        super(message, cause);
        this.invalidPasswordLengthFault = invalidPasswordLengthFault;
    }
