 ...
 *         &lt;element name="attachmentsExt" type="{http://schemas.datacontract.org/2004/07/SIAV.Archiflow.Entities.Posting.ValueObject}ArrayOfEMailAttachment" minOccurs="0"/>
...
public class Send2 {
    ...
    @XmlElement(nillable = true)
    protected ArrayOfEMailAttachment attachmentsExt;
    @XmlList
    ...
    /**
     * Gets the value of the attachmentsExt property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public ArrayOfEMailAttachment getAttachmentsExt() {
        return attachmentsExt;
    }

    /**
     * Sets the value of the attachmentsExt property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfEMailAttachment }
     *     
     */
    public void setAttachmentsExt(ArrayOfEMailAttachment value) {
        this.attachmentsExt = value;
    }
