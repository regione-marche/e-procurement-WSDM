...
public class IPostingServiceContractCheckUserRightToSendNotificationECInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public IPostingServiceContractCheckUserRightToSendNotificationECInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public IPostingServiceContractCheckUserRightToSendNotificationECInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
