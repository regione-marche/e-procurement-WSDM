 ...
 *         &lt;element name="eECType" type="{http://schemas.datacontract.org/2004/07/SIAV.Archiflow.Entities.Types}NotificationECType" minOccurs="0"/>
...
@XmlRootElement(name = "SendNotificationEC")
public class SendNotificationEC {

    @XmlElement(nillable = true)
    protected SessionInfo sessionInfo;
    protected String cardId;
    @XmlElement(name = "eECType")
    protected NotificationECType eecType;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the eecType property.
     * 
     * @return
     *     possible object is
     *     {@link NotificationECType }
     *     
     */
    public NotificationECType getEECType() {
        return eecType;
    }

    /**
     * Sets the value of the eecType property.
     * 
     * @param value
     *     allowed object is
     *     {@link NotificationECType }
     *     
     */
    public void setEECType(NotificationECType value) {
        this.eecType = value;
    }
