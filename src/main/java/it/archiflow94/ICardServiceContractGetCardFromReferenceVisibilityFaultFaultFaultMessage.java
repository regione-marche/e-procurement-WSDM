...
public class ICardServiceContractGetCardFromReferenceVisibilityFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractGetCardFromReferenceVisibilityFaultFaultFaultMessage(String message, it.archiflow94.VisibilityFault visibilityFault) {
        super(message);
        this.visibilityFault = visibilityFault;
    }

    public ICardServiceContractGetCardFromReferenceVisibilityFaultFaultFaultMessage(String message, it.archiflow94.VisibilityFault visibilityFault, Throwable cause) {
        super(message, cause);
        this.visibilityFault = visibilityFault;
    }
