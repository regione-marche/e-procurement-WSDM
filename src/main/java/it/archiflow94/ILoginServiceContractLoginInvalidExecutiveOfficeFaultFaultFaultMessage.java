...
public class ILoginServiceContractLoginInvalidExecutiveOfficeFaultFaultFaultMessage extends Exception {
    ...
    public ILoginServiceContractLoginInvalidExecutiveOfficeFaultFaultFaultMessage(String message, it.archiflow94.InvalidExecutiveOfficeFault invalidExecutiveOfficeFault) {
        super(message);
        this.invalidExecutiveOfficeFault = invalidExecutiveOfficeFault;
    }

    public ILoginServiceContractLoginInvalidExecutiveOfficeFaultFaultFaultMessage(String message, it.archiflow94.InvalidExecutiveOfficeFault invalidExecutiveOfficeFault, Throwable cause) {
        super(message, cause);
        this.invalidExecutiveOfficeFault = invalidExecutiveOfficeFault;
    }
