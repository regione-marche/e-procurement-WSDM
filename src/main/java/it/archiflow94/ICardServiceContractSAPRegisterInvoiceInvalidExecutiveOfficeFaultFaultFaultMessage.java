...
public class ICardServiceContractSAPRegisterInvoiceInvalidExecutiveOfficeFaultFaultFaultMessage extends Exception {
    ...
    public ICardServiceContractSAPRegisterInvoiceInvalidExecutiveOfficeFaultFaultFaultMessage(String message, it.archiflow94.InvalidExecutiveOfficeFault invalidExecutiveOfficeFault) {
        super(message);
        this.invalidExecutiveOfficeFault = invalidExecutiveOfficeFault;
    }

    public ICardServiceContractSAPRegisterInvoiceInvalidExecutiveOfficeFaultFaultFaultMessage(String message, it.archiflow94.InvalidExecutiveOfficeFault invalidExecutiveOfficeFault, Throwable cause) {
        super(message, cause);
        this.invalidExecutiveOfficeFault = invalidExecutiveOfficeFault;
    }
