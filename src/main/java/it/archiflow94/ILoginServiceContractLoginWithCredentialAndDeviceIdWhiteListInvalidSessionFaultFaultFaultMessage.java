...
public class ILoginServiceContractLoginWithCredentialAndDeviceIdWhiteListInvalidSessionFaultFaultFaultMessage extends Exception {
    ...
    public ILoginServiceContractLoginWithCredentialAndDeviceIdWhiteListInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault) {
        super(message);
        this.invalidSessionFault = invalidSessionFault;
    }

    public ILoginServiceContractLoginWithCredentialAndDeviceIdWhiteListInvalidSessionFaultFaultFaultMessage(String message, it.archiflow94.InvalidSessionFault invalidSessionFault, Throwable cause) {
        super(message, cause);
        this.invalidSessionFault = invalidSessionFault;
    }
