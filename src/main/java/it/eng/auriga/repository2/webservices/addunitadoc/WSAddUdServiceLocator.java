...
public class WSAddUdServiceLocator extends org.apache.axis.client.Service implements it.eng.auriga.repository2.webservices.addunitadoc.WSAddUdService {
    ...
    // Use to get a proxy class for WSAddUd
    ...
    public it.eng.auriga.repository2.webservices.addunitadoc.WSAddUd getWSAddUd() throws javax.xml.rpc.ServiceException {
    ...
    public it.eng.auriga.repository2.webservices.addunitadoc.WSAddUd getWSAddUd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.eng.auriga.repository2.webservices.addunitadoc.WSAddUdSoapBindingStub _stub = new it.eng.auriga.repository2.webservices.addunitadoc.WSAddUdSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.eng.auriga.repository2.webservices.addunitadoc.WSAddUd.class.isAssignableFrom(serviceEndpointInterface)) {
                it.eng.auriga.repository2.webservices.addunitadoc.WSAddUdSoapBindingStub _stub = new it.eng.auriga.repository2.webservices.addunitadoc.WSAddUdSoapBindingStub(new java.net.URL(WSAddUd_address), this);
                _stub.setPortName(getWSAddUdWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://addunitadoc.webservices.repository2.auriga.eng.it", "WSAddUdService");
    }
