 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://paleo.regione.marche.it/services/}reqDocumento">
 *       &lt;sequence>
 *         &lt;element name="CodiceRegistro" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="Emergenza" type="{http://paleo.regione.marche.it/services/}DatiEmergenza" minOccurs="0"/>
    ...
    extends ReqDocumento
{
    ...
    @XmlElement(name = "CodiceRegistro", required = true, nillable = true)
