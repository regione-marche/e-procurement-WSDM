 ...
 *         &lt;element name="WithouthStream" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReqCercaProtocollo {
    ...
    @XmlElement(name = "WithouthStream", nillable = true)
    protected Boolean withouthStream;
    ...
    /**
     * Gets the value of the withouthStream property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isWithouthStream() {
        return withouthStream;
    }

    /**
     * Sets the value of the withouthStream property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setWithouthStream(Boolean value) {
        this.withouthStream = value;
    }
