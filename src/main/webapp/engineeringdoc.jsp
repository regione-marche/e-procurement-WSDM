<table class="griglia">
	...
	<tr>
		...
		<td>Richiesta di inserimento di una unit&agrave; documentaria (senza protocollazione)</td>
		<td class="disp">Si</td>
	</tr>
	<tr>
		<td class="etichetta">WSDMDocumentoLeggi</td>
		<td>Lettura di una unit&agrave; documentaria</td>
		<td class="disp">Si</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Inserimento di un nuovo folder/fascicolo</td>
		<td class="disp">Si</td>
	</tr>
	<tr>
		<td class="etichetta">WSDMFascicoloAggiungiDocumento</td>
		<td>Aggiunta di una unit&agrave; documentaria ad un folder/fascicolo esistente</td>
		<td class="disp">No, disponibile contestualmente all'operazione di inserimento di una unit&agrave; documentaria</td>
	</tr>
	<tr>
		<td class="etichetta">WSDMFascicoloLeggi</td>
		<td>Lettura del folder/fascicolo e delle unit&agrave; documentarie associate</td>
		<td class="disp">Si</td>
	</tr>
	<tr>
