<table class="griglia">
	...
	<tr>
		...
		<td>Richiesta di inserimento di un elemento documentale</td>
		<td class="disp">Si (il sistema remoto protocolla anche in questo caso)</td>						
	</tr>
	<tr>
