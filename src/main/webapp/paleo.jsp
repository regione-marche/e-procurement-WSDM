<table class="griglia">
	...
	<tr>
		...
		<td class="disp">No, la lettura del protocollo e' possibile con l'operazione WSDMDocumentoLeggi (utilizzando il numero documento)</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="disp">No, disponibile contestualmente alle operazioni di inserimento protocollo e documento</td>						
	</tr>
	<tr>
