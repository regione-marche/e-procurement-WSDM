<table class="griglia">
	...
	<tr>
		...
		<td class="disp">No, disponibile contestualmente all'operazione di inserimento di un protocollo o di un elemento documentale</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="disp">No, e' possibile leggere l'atto o il contratto utilizzando l'operazione WSDMProtocolloLeggi con il numero protocollo, in quanto anche gli atti ed i contratti sono identificati dal numero protocollo</td>
	</tr>
	<tr>
